...
if ($action != ""): 
mail("$adminaddress","maillist",$mesaj,$headers);

//Kullanýcýya mail gönderiliyor
mail("$email","$sitename Kadýn Erkek Kuaför Güzellik & Zayýflama Merkezi", 
"Merhaba,\n
$sitename Kadýn Erkek Kuaför Güzellik & Zayýflama Merkezimize ait web sayfamýzý ziyaret ederek mail listemize katýldýðýnýz için teþekkürler, salonumuzda uygulanacak kampanyalarýmýz size mail yoluyla bildirilecektir.\n
