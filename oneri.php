...
$mesaj	 =$siteaddress." [Öneri ve Sikayet]<br>";
$mesaj	.="isim  :".$fname."<br>";
...
if ($action != ""): 
mail("$adminaddress","Öneri ve Sikayet",$mesaj,$headers);

//Kullanýcýya mail gönderiliyor
mail("$email","$sitename Kadýn Erkek Kuaför Güzellik & Zayýflama Merkezi", 
"Merhaba,\n
$sitename Kadýn Erkek Kuaför Güzellik & Zayýflama Merkezimize ait web sayfamýzý ziyaret ettiðiniz için teþekkürler, öneri veya þikayetiniz en kýsa süre içinde deðerlendirilerek tarafýnýza bilgi verilecektir.\n
...
//cevap
$sendresult = "Oneri veya sikayetiniz iletilmistir... ";
